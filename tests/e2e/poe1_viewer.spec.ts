...
test("poe1 area viewer load verification", async ({ page }) => {
  const url = "/webapp?tab=areas&area=1_1_town&game=poe1&graph=Metadata%2FTerrain%2FAct1%2FTown%2FGraphs%2Fbeachtown.dgr&room=beachtown&roomFile=Metadata%2FTerrain%2FAct1%2FTown%2FRooms%2Fbeach_town_unique_normal.arm";
